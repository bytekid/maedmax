...
val init : t_term -> int -> Yices.context -> Constraint.t list -> unit

val assert_constraints : t_term -> int -> Yices.context -> Constraint.t list -> unit

val bootstrap_constraint : int -> Yices.context -> Constraint.t list -> Yices.expr
